...
namespace Kee.RPGCore
{
    public class Combat : ICombat
    {
        ...
        public void GenerateCombatantsList()
        {
        ...
        public void RandomizeCombatOrder()
        {
        ...
        public void SwapCombatants(int i, int j)
        {
            if (i == j) return;
        ...
        public int NumLiving(int groupIndex)
        {
            int rv = 0;
        ...
        public bool GroupDead(int groupIndex)
        {
        ...
        public void FindNextLivingCombatant()
        {
            bool found = false;
            do
            {
        ...
        public ICharacter ChooseRandomLivingTarget(int groupIndex)
        {
